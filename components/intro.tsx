"use client";
import myself from "@/public/profile-pic-4.jpg";
    ...
    >
      ...
      <RoughNotationGroup show={isFontReady}>
        <h1 className="mb-10 mt-4 px-4 !leading-[1.5] sm:text-4xl">
          <span className="font-semibold">Hello 👋, I'm Amit, </span> a{" "}
          ...
          <p className="sm:text-[1.3rem]">
            ...
            <RainbowHighlight color={colors[4]}>
              back-end java and web development
            </RainbowHighlight>
            .
          </p>
          <p className="sm:text-[1.3rem]">
        ...
        <div className="flex items-center flex-col sm:flex-row justify-center gap-2 px-4 font-medium">
          <a
            href="https://www.linkedin.com/in/amit-khedkar-740481199/"
            target="_blank"
          ...
          <Link
            href="https://github.com/amitkhedkar41"
            target="_blank"
